 ...
 <div class="row mt-4">
  ...
  <div class="col-sm-3">
   ...
   <div class="col-sm-6 p-4">
    <form action="<?php  echo base_url(); ?>Welcome/adminlog" method="post" enctype="multipart/form-data">
    <fieldset>
     <legend class="text-center text-info"><i class="fa fa-lock"></i> Login</legend>
      <div class="form-group">
        <label class="text-info"><i class="fa fa-user"></i> Username <span class="text-danger">*</span></label>
        <input type="email" name="email" placeholder=" Email or Phone " class="form-control">
        
      </div>

      <div class="form-group">
        <label class="text-info"><i class="fa fa-key"></i> Password <span class="text-danger">*</span></label>
